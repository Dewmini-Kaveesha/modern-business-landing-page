            ...
            <div className='hidden md:flex items-center gap-10'>
                {
                    navLinks.map((link,index) => (
                        ...
                        className={`text-sm font-medium relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-blue-600 after:transition-all ${activeLink === link.href ? 'text-blue-600 after:w-full' : 'text-gray-700'}`}
                ...
                <div className='md:hidden bg-white border-t border-gray-100 py-4'>
                    <div className='container mx-auto px-4 space-y-3'>
                        { navLinks.map((link,index) => (
                            ...
                            className={'block text-sm font-medium py-2 ${activeLink===link.href ? "text-blue-600" "text-gray-600 hover:900"}'} href={link.href}>{link.label}</a>
                        ))}
